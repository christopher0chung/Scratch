...
public class BezierDraw_Intermediate : Editor
{
    ...
    private void OnSceneGUI()
    {
        ...
        //bb.startPoint = Handles.PositionHandle(bb.precedingBez.endPoint, Quaternion.identity);
        ...
        //bb.startTangent = Handles.PositionHandle(oppositeDir, Quaternion.identity);
...
public class BezierDraw_LoopConnect : Editor
{
    ...
    private void OnSceneGUI()
    {
        ...
        //bb.endPoint = Handles.PositionHandle(bb.firstBez.startPoint, Quaternion.identity);
        ...
        //bb.endTangent = Handles.PositionHandle(oppositeDirForFirst, Quaternion.identity);
