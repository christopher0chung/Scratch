...
public class MeshWriter : MonoBehaviour
{
    ...
    private void _ComputeMesh()
    {
        ...
        _uVs = new Vector2[6];
        _uVs[0] = new Vector2(0 + Time.time, 0);
        _uVs[1] = new Vector2(1 + Time.time, 0);
        _uVs[2] = new Vector2(0 + Time.time, 1);
        _uVs[3] = new Vector2(0 + Time.time, 1);
        _uVs[4] = new Vector2(1 + Time.time, 1);
        _uVs[5] = new Vector2(1 + Time.time, 0);
    }
